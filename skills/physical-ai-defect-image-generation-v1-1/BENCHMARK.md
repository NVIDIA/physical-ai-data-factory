# Skill Benchmark: physical-ai-defect-image-generation-v1-1
...
- Skill: `physical-ai-defect-image-generation-v1-1`
- Evaluation date: 2026-09-01
- Evaluator version: `1.3.2`
- Agents: Claude Code (`aws/anthropic/bedrock-claude-opus-4-8`), Codex (`openai/openai/gpt-5.5`)
- Tasks: 6 evaluation tasks (6 positive)
- Dataset digest: `sha256:8f44d24d83aed9f568233744271b4f3a9844aee331d9bfa1e8f6543114d1da17` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 1
...
- **MEDIUM** SCHEMA/frontmatter_field_placement: Root field 'version' is ignored; use 'metadata.version' (`skills/physical-ai-defect-image-generation-v1-1/SKILL.md`)
- **MEDIUM** SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`skills/physical-ai-defect-image-generation-v1-1/SKILL.md`)
- **MEDIUM** SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`skills/physical-ai-defect-image-generation-v1-1/SKILL.md`)
- **LOW** SCHEMA/author_format: Author must be of the form 'Name <email@host>' (`skills/physical-ai-defect-image-generation-v1-1/SKILL.md`)
